...
int main()
{
	...
	// auto convert to class type
	//cout << "using implicit  conversions";
	// Time time2 = 22;  这个赋值在构造函数不含有expicit 的情况成立，如果带上expicit 这句话将编译错误。
	
	cout << "using explicit  conversions";
	Time time2 = Time(33);
	time2.show_time();
	
	cout<< "convert class var  to int: ";
	int itime = time2;
	cout << itime<< endl;
}
